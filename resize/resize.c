...
int main(int argc, char *argv[])
{
    ...
    // manipulation of header
    BITMAPFILEHEADER outfilebf = bf;
    BITMAPINFOHEADER outfilebi = bi;
    outfilebi.biWidth = outfilebi.biWidth * n;
    outfilebi.biHeight = outfilebi.biHeight * n;
